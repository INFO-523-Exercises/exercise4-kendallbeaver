...
X_train <- as_tibble(train_data$X)
y_train <- as_tibble(train_data$y)

X_test <- as_tibble(test_data$X)
...
# The pipe through command "pull(.pred)" below wasn't be recoganized as an applicable method so I removed it.
